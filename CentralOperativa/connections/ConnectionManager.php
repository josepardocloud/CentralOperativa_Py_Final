...
class ConnectionManager
{
	...
	{
		return $this->byId( "Jardines_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "Jardines_at_localhost";
		$data["connName"] = "Jardines at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;Jardines;;1"; //currently unused

		$this->_connectionsIdByName["Jardines at localhost"] = "Jardines_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "Jardines";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=Jardines;OPTION=3";
		// encription set
		...
		$connectionsData["Jardines_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["sede"] = "Jardines_at_localhost";
		$connectionsIds["vehiculos"] = "Jardines_at_localhost";
		$connectionsIds["ataud"] = "Jardines_at_localhost";
		$connectionsIds["tiposervicio"] = "Jardines_at_localhost";
		$connectionsIds["causamuerte"] = "Jardines_at_localhost";
		$connectionsIds["velatrorio"] = "Jardines_at_localhost";
		$connectionsIds["urna"] = "Jardines_at_localhost";
		$connectionsIds["ubigeo"] = "Jardines_at_localhost";
		$connectionsIds["personal"] = "Jardines_at_localhost";
		$connectionsIds["adicional"] = "Jardines_at_localhost";
		$connectionsIds["categorias"] = "Jardines_at_localhost";
		$connectionsIds["servicioadicional"] = "Jardines_at_localhost";
		$connectionsIds["servicio"] = "Jardines_at_localhost";
		$connectionsIds["detalleservicio"] = "Jardines_at_localhost";
		$connectionsIds["Instalacion"] = "Jardines_at_localhost";
		$connectionsIds["Despacho"] = "Jardines_at_localhost";
		$connectionsIds["usuario"] = "Jardines_at_localhost";
