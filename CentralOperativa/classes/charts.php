...
class Chart
{
	...
	protected function isProjectDB()
	{
		...
		if("sede" == $this->chrt_array['tables'][0])
			return true;
		if("vehiculos" == $this->chrt_array['tables'][0])
			return true;
		if("ataud" == $this->chrt_array['tables'][0])
			return true;
		if("tiposervicio" == $this->chrt_array['tables'][0])
			return true;
		if("causamuerte" == $this->chrt_array['tables'][0])
			return true;
		if("velatrorio" == $this->chrt_array['tables'][0])
			return true;
		if("urna" == $this->chrt_array['tables'][0])
			return true;
		if("ubigeo" == $this->chrt_array['tables'][0])
			return true;
		if("personal" == $this->chrt_array['tables'][0])
			return true;
		if("adicional" == $this->chrt_array['tables'][0])
			return true;
		if("categorias" == $this->chrt_array['tables'][0])
			return true;
		if("servicioadicional" == $this->chrt_array['tables'][0])
			return true;
		if("servicio" == $this->chrt_array['tables'][0])
			return true;
		if("detalleservicio" == $this->chrt_array['tables'][0])
			return true;
		if("detalleservicio" == $this->chrt_array['tables'][0])
			return true;
		if("detalleservicio" == $this->chrt_array['tables'][0])
