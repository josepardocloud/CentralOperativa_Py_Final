...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "sede" ] = array( "url" => "sede", "type" => 0 );
	$projectEntitiesReverse[ "sede" ] = "sede";
	$projectEntities[ "vehiculos" ] = array( "url" => "vehiculos", "type" => 0 );
	$projectEntitiesReverse[ "vehiculos" ] = "vehiculos";
	$projectEntities[ "ataud" ] = array( "url" => "ataud", "type" => 0 );
	$projectEntitiesReverse[ "ataud" ] = "ataud";
	$projectEntities[ "tiposervicio" ] = array( "url" => "tiposervicio", "type" => 0 );
	$projectEntitiesReverse[ "tiposervicio" ] = "tiposervicio";
	$projectEntities[ "causamuerte" ] = array( "url" => "causamuerte", "type" => 0 );
	$projectEntitiesReverse[ "causamuerte" ] = "causamuerte";
	$projectEntities[ "velatrorio" ] = array( "url" => "velatrorio", "type" => 0 );
	$projectEntitiesReverse[ "velatrorio" ] = "velatrorio";
	$projectEntities[ "urna" ] = array( "url" => "urna", "type" => 0 );
	$projectEntitiesReverse[ "urna" ] = "urna";
	$projectEntities[ "ubigeo" ] = array( "url" => "ubigeo", "type" => 0 );
	$projectEntitiesReverse[ "ubigeo" ] = "ubigeo";
	$projectEntities[ "personal" ] = array( "url" => "personal", "type" => 0 );
	$projectEntitiesReverse[ "personal" ] = "personal";
	$projectEntities[ "adicional" ] = array( "url" => "adicional", "type" => 0 );
	$projectEntitiesReverse[ "adicional" ] = "adicional";
	$projectEntities[ "categorias" ] = array( "url" => "categorias", "type" => 0 );
	$projectEntitiesReverse[ "categorias" ] = "categorias";
	$projectEntities[ "servicioadicional" ] = array( "url" => "servicioadicional", "type" => 0 );
	$projectEntitiesReverse[ "servicioadicional" ] = "servicioadicional";
	$projectEntities[ "servicio" ] = array( "url" => "servicio", "type" => 0 );
	$projectEntitiesReverse[ "servicio" ] = "servicio";
	$projectEntities[ "detalleservicio" ] = array( "url" => "detalleservicio", "type" => 0 );
	$projectEntitiesReverse[ "detalleservicio" ] = "detalleservicio";
	$projectEntities[ "Instalacion" ] = array( "url" => "instalacion", "type" => 1 );
	$projectEntitiesReverse[ "instalacion" ] = "Instalacion";
	$projectEntities[ "Despacho" ] = array( "url" => "despacho", "type" => 1 );
	$projectEntitiesReverse[ "despacho" ] = "Despacho";
